  ...
  return (
    ...
    <div className="sidebar-scroll">
        <div className="user-account">
            <img src="assets/images/user.png" className="rounded-circle user-photo" alt="User Profile Picture"/>
                ...
                <nav id="left-sidebar-nav" className="sidebar-nav">
                    <ul id="main-menu" className="metismenu li_animation_delay">
                        <li className="active">
                            ...
                            <ul>
                                <li className="active"><Link to='/dashboard' >Analyticalss</Link></li>
                                <li><Link to='/currency' >Currency Master</Link></li>
                                <li><Link to='/location' >Location Master</Link></li>
                ...
                <ul className="list-unstyled font_setting mt-3">
                    <li>
                        <label className="custom-control custom-radio custom-control-inline">
                            <input type="radio" className="custom-control-input" name="font" defaultValue="font-nunito" />
                            <span className="custom-control-label">Nunito Google Font</span>
                        </label>
                    </li>
                    <li>
                        <label className="custom-control custom-radio custom-control-inline">
                            <input type="radio" className="custom-control-input" name="font" defaultValue="font-ubuntu"/>
                            <span className="custom-control-label">Ubuntu Font</span>
                        </label>
                    </li>
                    <li>
                        <label className="custom-control custom-radio custom-control-inline">
                            <input type="radio" className="custom-control-input" name="font" defaultValue="font-raleway"/>
                            <span className="custom-control-label">Raleway Google Font</span>
                        </label>
                    </li>
                    <li>
                        <label className="custom-control custom-radio custom-control-inline">
                            <input type="radio" className="custom-control-input" name="font" defaultValue="font-IBMplex"/>

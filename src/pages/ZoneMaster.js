...
import { EntityParams, ZoneParams } from "./model/masters"
...
const defaultParams = ZoneParams;
  ...
  const delDate = (data = null) => {
    const filteredData = tableData.filter(
      (item) => item.ZoneCode !== data.ZoneCode
    );
  ...
  const editDate = (data) => {
    ...
    if (data) {
      ...
      setParams({
        id: obj.ZoneCode ? obj.ZoneCode : null,
        ZoneName: obj.ZoneName ? obj.ZoneName : null,
  ...
  const saveEvent = (params) => {
    if (!params.id === null) {
      ...
      event.ZoneName = params.ZoneName;
              ...
              <div class="card">
                <div class="body">
                  <a
                    ...
                    type="button">
                    <i class="icon wb-plus" aria-hidden="true"></i> Add Zone
                  </a>

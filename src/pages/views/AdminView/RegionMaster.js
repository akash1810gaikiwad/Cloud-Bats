...
import{ RegionParams } from "../../model/masters"
...
const RegionMaster = () => {
  ...
  const editDate = (data) => {
    let params = JSON.parse(JSON.stringify(RegionParams));
    setParams(params);
    if (data) {
  ...
  const saveEvent = (params) => {
    ...
    let params2 = JSON.parse(JSON.stringify(RegionParams));
    setParams(params2);
              ...
              <div class="card">
                <div class="body">
                  <a
                    ...
                    type="button">
                    <i class="icon wb-plus" aria-hidden="true"></i> Add Region
                  </a>

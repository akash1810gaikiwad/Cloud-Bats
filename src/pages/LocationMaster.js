...
import { AddLocation, getLocation } from '../Global';
...
const LocationMaster = () => {
    ...
    const defaultParams = { EntityId: '',EntityName: '',PermAddress: '',CorpAddress: '',ContactPerson: '',Contact: '',IsActive: '',PANNO: '',CINNumber: ''};
    ...
    const saveEvent = (params) => {
        ...
        if (!params.id===null) {
            ...
            AddLocation(params,LoginCode,token,navigate)
                    ...
                    <div className="card">
                        ...
                        <div class="body">
                            ...
                            <a href="#largeModal" data-toggle="modal" data-target="#largeModal" id="addToTable" class="btn btn-primary m-b-15" type="button">
                                <i class="icon wb-plus" aria-hidden="true"></i> Add Location
                            </a>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <button class="dropdown-item" type="button">Something else here</button>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <span class="input-group-text" style={{width:100}}>PANNO</span>
                                </div>
                                <input type="text" 
                                class="form-control" 
